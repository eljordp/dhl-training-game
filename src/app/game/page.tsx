...
function emptyForm(): ShipmentForm {
  return {
    ...
    shipper: { companyName: "", contactName: "", address1: "", address2: "", phone: "", email: "", partyTraderType: "" },
    consignee: { companyName: "", contactName: "", address1: "", address2: "", phone: "", email: "", partyTraderType: "" },
