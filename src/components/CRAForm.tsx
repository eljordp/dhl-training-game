...
const COMMODITY_SUGGESTIONS = [
  ...
  "0207 MEAT OF POULTRY FRESH CHILLED FROZEN",
  "0402 MILK AND CREAM CONCENTRATED SWEETENED",
  "0409 NATURAL HONEY",
  "0504 ANIMAL GUTS BLADDERS STOMACHS",
  "0713 DRIED LEGUMINOUS VEGETABLES BEANS LENTILS",
  "0901 COFFEE",
  "0902 TEA",
  "1006 RICE",
  ...
  "2009 FRUIT JUICES",
  "2101 EXTRACTS OF COFFEE TEA",
  "2103 SAUCES CONDIMENTS SEASONINGS",
  ...
  "3005 BANDAGES DRESSINGS MEDICAL",
  ...
  "3307 PERFUMES DEODORANTS",
  "3401 SOAP",
  "3402 CLEANING PREPARATIONS DETERGENTS",
  "3406 CANDLES TAPERS",
  "3506 PREPARED GLUES ADHESIVES",
  "3808 INSECTICIDES HERBICIDES DISINFECTANTS",
  "3923 PLASTIC ARTICLES FOR PACKING",
  "3924 PLASTIC HOUSEHOLD ARTICLES TABLEWARE",
  "3926 OTHER ARTICLES OF PLASTICS",
  // Paper & Printed
  "4202 TRUNKS SUITCASES HANDBAGS WALLETS",
  "4203 ARTICLES OF LEATHER BELTS STRAPS",
  ...
  "6101 MEN KNITTED OVERCOATS JACKETS",
  "6103 MEN KNITTED SUITS TROUSERS",
  "6104 WOMEN KNITTED SUITS DRESSES SKIRTS",
  "6105 MEN KNITTED SHIRTS",
  "6106 WOMEN KNITTED BLOUSES SHIRTS",
  "6107 MEN KNITTED UNDERPANTS PYJAMAS ROBES",
  "6108 WOMEN KNITTED SLIPS PETTICOATS PYJAMAS",
  ...
  "6201 MEN OVERCOATS CLOAKS CAPES",
  "6203 MEN SUITS JACKETS TROUSERS",
  "6204 WOMEN SUITS ENSEMBLES DRESSES",
  "6205 MEN SHIRTS",
  "6206 WOMEN BLOUSES SHIRTS",
  "6207 MEN SINGLETS UNDERPANTS PYJAMAS",
  "6208 WOMEN SLIPS PETTICOATS NIGHTDRESSES",
  "6209 BABIES GARMENTS WOVEN",
  "6211 TRACKSUITS SKI SUITS SWIMWEAR",
  "6212 BRASSIERES GIRDLES CORSETS",
  "6214 SHAWLS SCARVES VEILS",
  "6216 GLOVES MITTENS",
  "6217 CLOTHING ACCESSORIES",
  "6302 BED LINEN TABLE LINEN TOILET LINEN",
  "6304 FURNISHING ARTICLES BEDSPREADS CUSHIONS",
  "6305 SACKS AND BAGS FOR PACKING",
  // Footwear & Headgear
  "6401 WATERPROOF FOOTWEAR RUBBER PLASTIC",
  "6402 FOOTWEAR OUTER SOLES RUBBER PLASTIC",
  "6403 FOOTWEAR OUTER SOLES RUBBER LEATHER UPPER",
  "6404 FOOTWEAR OUTER SOLES RUBBER TEXTILE UPPER",
  "6405 OTHER FOOTWEAR",
  "6406 PARTS OF FOOTWEAR INSOLES",
  "6504 HATS PLAITED OR ASSEMBLED",
  "6505 HATS KNITTED OR CROCHETED",
  "6506 OTHER HEADGEAR",
  // Ceramics & Glass
  "6911 CERAMIC TABLEWARE KITCHEN ARTICLES",
  "6912 CERAMIC HOUSEHOLD ARTICLES OTHER",
  "6913 CERAMIC ORNAMENTAL ARTICLES",
  "7013 GLASSWARE FOR TABLE KITCHEN TOILET",
  "7018 GLASS BEADS IMITATION PEARLS",
  // Metals & Jewelry
  "7113 ARTICLES OF JEWELRY PRECIOUS METAL",
  "7117 IMITATION JEWELRY",
  "7308 STRUCTURES OF IRON OR STEEL",
  "7318 SCREWS BOLTS NUTS WASHERS",
  "7321 STOVES RANGES GRATES COOKERS",
  "7323 TABLE KITCHEN HOUSEHOLD ARTICLES IRON STEEL",
  "7326 OTHER ARTICLES OF IRON OR STEEL",
  "7418 TABLE KITCHEN HOUSEHOLD ARTICLES COPPER",
  "7615 TABLE KITCHEN HOUSEHOLD ARTICLES ALUMINIUM",
  ...
  "8421 CENTRIFUGES FILTERING MACHINERY",
  "8422 DISHWASHING MACHINES FILLING SEALING",
  "8432 AGRICULTURAL MACHINERY PLOUGHS",
  "8443 PRINTING MACHINERY PRINTERS COPIERS",
  "8450 HOUSEHOLD LAUNDRY MACHINES WASHING",
  "8467 HAND TOOLS PNEUMATIC HYDRAULIC",
  "8471300000 PORTABLE DIGITAL ADP MACHINES LAPTOPS",
  "8471410000 ADP MACHINES DESKTOP COMPUTERS",
  "8471600000 INPUT OUTPUT UNITS KEYBOARDS MONITORS",
  "8473 PARTS OF ADP MACHINES COMPUTER PARTS",
  "8501 ELECTRIC MOTORS AND GENERATORS",
  "8504 ELECTRICAL TRANSFORMERS POWER SUPPLIES",
  "8506 PRIMARY CELLS BATTERIES",
  "8507 ELECTRIC ACCUMULATORS BATTERIES RECHARGEABLE",
  "8509 ELECTRO-MECHANICAL DOMESTIC APPLIANCES",
  "8510 SHAVERS HAIR CLIPPERS EPILATORS",
  "8516 ELECTRIC WATER HEATERS HAIR DRYERS IRONS",
  "8517110000 TELEPHONE SETS CORDLESS HANDSETS",
  "8517130000 SMARTPHONES TELEPHONES",
  "8517620000 ROUTERS SWITCHES NETWORKING",
  "8518 MICROPHONES LOUDSPEAKERS HEADPHONES",
  "8519 SOUND RECORDING REPRODUCING APPARATUS",
  "8521 VIDEO RECORDING APPARATUS",
  "8523 DISCS TAPES STORAGE MEDIA USB DRIVES",
  "8525 CAMERAS TV CAMERAS WEBCAMS",
  "8527 RADIO RECEIVERS",
  "8528 MONITORS PROJECTORS TELEVISION RECEIVERS",
  "8529 PARTS FOR TELEVISIONS MONITORS",
  "8534 PRINTED CIRCUITS",
  "8536 ELECTRICAL SWITCHES CONNECTORS PLUGS",
  ...
  "8712 BICYCLES",
  "8714 PARTS FOR MOTORCYCLES BICYCLES",
  // Optical & Medical
  "9001 OPTICAL FIBRES LENSES",
  "9003 FRAMES FOR SPECTACLES GOGGLES",
  "9004 SPECTACLES GOGGLES SUNGLASSES",
  "9006 PHOTOGRAPHIC CAMERAS FLASH",
  "9018 MEDICAL INSTRUMENTS AND APPLIANCES",
  "9019 MECHANO-THERAPY MASSAGE APPARATUS",
  "9021 ORTHOPEDIC APPLIANCES HEARING AIDS",
  "9025 THERMOMETERS HYDROMETERS BAROMETERS",
  "9027 INSTRUMENTS FOR PHYSICAL CHEMICAL ANALYSIS",
  // Watches & Clocks
  "9101 WRIST-WATCHES PRECIOUS METAL",
  "9102 WRIST-WATCHES OTHER",
  "9103 CLOCKS WITH WATCH MOVEMENTS",
  "9105 OTHER CLOCKS WALL DESK ALARM",
  "9111 WATCH CASES",
  "9113 WATCH STRAPS BANDS",
  // Furniture & Household
  "9401 SEATS AND PARTS THEREOF",
  "9403 OTHER FURNITURE SHELVES CABINETS",
  "9404 MATTRESS SUPPORTS MATTRESSES PILLOWS",
  "9405 LAMPS LIGHTING FITTINGS CHANDELIERS",
  // Toys & Sports
  "9503000000 TOYS AND GAMES",
  "9504 VIDEO GAME CONSOLES ARCADE MACHINES",
  "9505 FESTIVE CARNIVAL CHRISTMAS ARTICLES",
  "9506 SPORTS EQUIPMENT EXERCISE",
  "9507 FISHING RODS REELS TACKLE",
  // Miscellaneous
  "9601 WORKED IVORY BONE HORN CORAL",
  "9602 WORKED VEGETABLE MATERIALS WAXES",
  "9603 BROOMS BRUSHES MOPS",
  "9608 BALL POINT PENS FELT TIPPED PENS MARKERS",
  "9609 PENCILS CRAYONS CHALKS",
  "9611 HAND STAMPS DATE STAMPS SEALS",
  "9613 CIGARETTE LIGHTERS",
  "9614 SMOKING PIPES",
  "9615 COMBS HAIR PINS CURLING PINS",
  "9617 VACUUM FLASKS THERMOS",
  "9618 TAILORS DUMMIES MANNEQUINS",
  "9706 ANTIQUES OVER 100 YEARS OLD",
  // Documents & Legal
  "4901100000 DOCUMENTS LEGAL PAPERS CONTRACTS",
  "4907001000 IMMIGRATION DOCUMENTS VISAS",
  "4911991000 COMMERCIAL DOCUMENTS CERTIFICATES",
];
